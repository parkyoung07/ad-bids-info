...
export default function Chatbot() {
  ...
  // 5단계 정형화 응답 생성기 (결론 -> 분석 핵심 -> 추가 확인 필요 -> 근거 -> 면책 안내)
...
[ 2. 공고 분석 핵심 내용 ]
• 세부품명 10자리 번호가 공고 조건과 완벽히 일치해야 합니다.
...
[ 4. 근거 ]
중소기업제품 구매촉진 및 판로지원에 관한 법률 관련 규정

※ AI 답변은 참고용입니다. 실제 입찰 전 나라장터 원문을 별도로 확인해야 합니다.`;
    }
...
[ 3. 추가 확인이 필요한 내용 ]
• 공동도급(공동이행방식) 허용 여부를 세부 조건에서 최종 확인하십시오.

[ 4. 근거 ]
옥외광고물 등의 관리와 옥외광고산업 진흥에 관한 법률 관련 규정
...
• 필수자격: ${currentBid.verifiedRequirements?.license || "옥외광고사업 등록 (예시)"}
• 직접생산: ${currentBid.verifiedRequirements?.directProduction || "해당 세부품명 직생증명서 (예시)"}
...
[ 4. 근거 ]
DEMO 분석 예시: 실제 공고문을 업로드하면 해당 문구와 위치를 추출합니다.
...
• 투찰 전 적격심사 세부기준의 낙찰하한율을 반드시 확인하십시오.
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-[10px] text-slate-400">
                  {currentBid ? `[${currentBid.title.substring(0, 16)}...] 공고 기준` : "공공입찰 맞춤형 AI 질의응답"}
                </p>
              </div>
            </div>
