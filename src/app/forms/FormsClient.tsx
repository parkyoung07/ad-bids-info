...
신청인: [회사명] 대표 [대표자명] (직인)
  ...
  },
  {
    id: "FORM-09",
    category: "자격/인증",
    title: "9. 옥외광고물 손해배상책임 단체보험(공제) 가입신청서 및 시·도협회 접수처",
    desc: "옥외광고물법 제10조의4에 따른 법정 의무 손해배상책임 단체보험(공제) 가입신청서 및 전국 17개 시·도 협회 대표 연락처 안내입니다.",
    format: "HWP",
    isHot: true,
    content: `
[옥외광고물 손해배상책임보험(공제) 가입신청서]

1. 신청 사업자 정보:
   - 상호(법인명): [상호명 기재]
   - 사업자등록번호: [000-00-00000]
   - 옥외광고사업등록번호: [제 2026-0000호]
   - 대표자 성명: [대표자명] (생년월일: 0000.00.00)
   - 사업장 주소: [사업장 도로명 주소]
   - 대표 전화번호: [000-000-0000]  (휴대전화: 010-0000-0000)
   - 이메일 / 팩스: [이메일 주소] / [팩스번호]

2. 가입 공제(보험) 보장 내용:
   - 대인 배상: 피해자 1인당 최고 1억 5,000만 원 (부상 등급별 최고 3,000만 원)
   - 대물 배상: 사고 1건당 최고 1억 원
   - 담보 위험: 옥외광고물의 제작·표시·설치 하자 및 낙하·파손으로 인한 제3자 손해

3. 공제료 산정 기준 자료:
   - 전년도 연간 매출액 (부가가치세 과세표준증명원 기준): [000,000,000] 원
   - 상시 종업원 수: [ 0 ] 명

4. 첨부 서류:
   가. 옥외광고사업등록증 사본 1부
   나. 사업자등록증 사본 1부
   다. 전년도 부가가치세 과세표준증명원 1부

5. 전국 17개 시·도 협회 접수처 안내 (한국옥외광고협회 중앙회: 02-889-8855):
   • 서울(02-882-9500) • 부산(051-466-8736) • 대구(053-604-4380) • 인천(032-427-4111)
   • 광주(062-232-6040) • 대전(042-254-2393) • 울산(052-266-0535) • 세종(044-865-0010)
   • 경기(031-251-8600) • 강원(033-645-4903) • 충북(043-266-4301) • 충남(041-681-6522)
   • 전북(063-250-0200) • 전남(061-243-0333) • 경북(054-654-0633) • 경남(055-237-4343)
   • 제주(064-739-4000)

위와 같이 옥외광고물 손해배상책임 단체보험(공제) 가입을 신청합니다.
      ...
      <section className="relative overflow-hidden bg-gradient-to-b from-slate-900 via-slate-950 to-slate-950 border-b border-slate-800 py-12 px-4">
        <div className="max-w-4xl mx-auto text-center space-y-4">
          ...
          <h1 className="text-2xl sm:text-4xl font-black text-white tracking-tight">
            옥외광고 공공입찰 <span className="text-cyan-400">필수 서류 9종</span> 무료 자료실
          </h1>
          <p className="text-xs sm:text-sm text-slate-400 max-w-2xl mx-auto leading-relaxed">
            적격심사 자기평가표, 직접생산확인 신청서, 배상책임보험 가입신청서, 위임장, 하자보수 확약서 등
